...
//	private DataSource dataSource;
	...
	public RewardConfirmation confirmReward(AccountContribution contribution, Dining dining) {
		...
		int rowsAffected = jdbcTemplate.update(sql, (PreparedStatement ps) -> { 
		...
		System.out.println("Rows affected by confirmReward="+rowsAffected);
...
//		}
	...
	private String nextConfirmationNumber() {
		...
		String confirmationNumber = jdbcTemplate.queryForObject(sql, String.class);
